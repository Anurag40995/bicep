...
resource nsgSpoke 'Microsoft.Network/networkSecurityGroups@2023-04-01' = {
...
resource spokenetwork1 'Microsoft.Network/virtualNetworks@2023-04-01' = {
  name: 'vnet-spoke1'
  location: location
  properties: {
    addressSpace: {
...
resource spokenetwork2 'Microsoft.Network/virtualNetworks@2023-04-01' = {
  name: 'vnet-spoke2'
  location: location
  properties: {
    addressSpace: {
...
resource peerToSpoke1 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2023-04-01' = {
...
resource peerFromSpoke1 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2023-04-01' = {
...
resource peerToSpoke2 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2023-04-01' = {
...
resource peerFromSpoke2 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2023-04-01' = {
...
resource pipFirewall 'Microsoft.Network/publicIPAddresses@2023-04-01' = {
  name: 'pip-Firewall'
  location: location
  sku: {
    name: 'Standard'
